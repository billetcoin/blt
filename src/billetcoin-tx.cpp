...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Billetcoin Core billetcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  billetcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded billetcoin transaction") + "\n" +
                               "  billetcoin-tx [options] -create [commands]   " + _("Create hex-encoded billetcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded billetcoin transaction
