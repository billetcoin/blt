...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 30145;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Billetcoin starting difficulty is 1 / 2^12
        ...
        nBilletcoinBadBlocknBits = 0x00; // Skip nBit validation of Block 259201 per PR #915
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "He had reached the point where he was paranoid about being paranoid.";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1591612909;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 62634;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("000006cae0d35b6935f48801b203e2d357c7a93ebe8f39d99ea84e60a97ee60f"));
        assert(genesis.hashMerkleRoot == uint256("7f9353d3e6af4a0f0db34ba5b830ac7608c65c681f7008101fc9f6388ab31d0f"));
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nLastPOWBlock = 200;
        nBilletcoinBadBlockTime = 1489001494; // Skip nBit validation of Block 259201 per PR #915
        nBilletcoinBadBlocknBits = 0x1e0a20bd; // Skip nBit validation of Block 201 per PR #915
        nMaturity = 15;
        nStakeMinDepth = 100;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "billetcoin-testnet.seed.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "billetcoin-testnet.seed2.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("warrows.dev", "testnet.dnsseed.billetcoin.warrows.dev"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet billetcoin addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet billetcoin script addresses start with '8' or '9'
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 73);     // starting with 'W'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet billetcoin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet billetcoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet billetcoin BIP44 coin type is '1' (All coin's testnet default)
