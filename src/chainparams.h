 ...
 * Billetcoin system. There are three: the main network on which people trade goods
...
public:
    ...
    int BilletcoinBadBlockTime() const { return nBilletcoinBadBlockTime; }
    int BilletcoinBadBlocknBits() const { return nBilletcoinBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nBilletcoinBadBlockTime;
