// Copyright (c) 2017-2020 The Billetcoin developers
    ...
    model(0)
{
    ...
    // Title
    ui->labelTitle->setText(tr("Select zBLT Denominations to Spend"));
    ...
    for (const CMintMeta& mint : setMints) {
        ...
        if(!fSpendable) {
            ...
            if(nConfirmations < Params().Zerocoin_MintRequiredConfirmations())
                ...
                strReason = "Your wallet is locked. Impossible to spend zBLT.";
            else if (!mint.isSeedCorrect)
                strReason = "The zBLT seed used to mint this zBLT is not the same as currently hold in the wallet";
            else
