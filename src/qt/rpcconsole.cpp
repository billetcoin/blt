                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzBLTPathCustom = GetArg("-zpivbackuppath", "");
    ...
    if(!strzBLTPathCustom.empty()) {
        ui->wallet_customzpivbackuppath->setText(QString::fromStdString(strzBLTPathCustom));
        ui->wallet_customzpivbackuppath_label->setVisible(true);
        ui->wallet_customzpivbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzBLTPathCustom.empty()) && nCustomBackupThreshold > 0) {
