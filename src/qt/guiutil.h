...
/** Utility functions used by the Billetcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render Billetcoin addresses in monospace font
...
// Parse "billetcoin:" URI into recipient object, return true on successful parsing
