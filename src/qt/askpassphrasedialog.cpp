...
#include "qt/billetcoin/loadingdialog.h"
...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        bool ret = openStandardDialog(
                ...
                tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR BLT</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
                tr("ENCRYPT"), tr("CANCEL")
        );
        if (ret) {
            if (newpass1 == newpass2) {
                newpassCache = newpass1;
                BilletcoinGUI* window = static_cast<BilletcoinGUI*>(parentWidget());
...
{
    BilletcoinGUI* gui = static_cast<BilletcoinGUI*>(parentWidget());
...
{
    hide();
    static_cast<BilletcoinGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("Billetcoin will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your BLTs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
