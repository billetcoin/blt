...
#include "qt/billetcoin/forms/ui_dashboardwidget.h"
#include "qt/billetcoin/sendconfirmdialog.h"
#include "qt/billetcoin/txrow.h"
...
DashboardWidget::DashboardWidget(BilletcoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::DashboardWidget)
{
    ...
    // Staking Information
    ui->labelMessage->setText(tr("Amount of BLT staked."));
    ...
    ui->labelAmountPiv->setText("0 BLT");
    ...
    ui->btnHowTo->setText(tr("How to get BLT"));
...
const QMap<int, std::pair<qint64, qint64>> DashboardWidget::getAmountBy() {
    ...
    for (int i = 0; i < size; ++i) {
        ...
        bool isPiv = modelIndex.data(TransactionTableModel::TypeRole).toInt() != TransactionRecord::StakeZBLT;
...
bool DashboardWidget::loadChartData(bool withMonthNames) {
    ...
    chartData->amountsByCache = getAmountBy(); // pair BLT, zBLT
