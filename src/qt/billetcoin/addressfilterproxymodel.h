...
#ifndef Billetcoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define Billetcoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //Billetcoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
