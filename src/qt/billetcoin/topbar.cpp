...
#include "qt/billetcoin/forms/ui_topbar.h"
#include <QPixmap>
#include "qt/billetcoin/lockunlock.h"
#include "qt/billetcoin/qtutils.h"
#include "qt/billetcoin/receivedialog.h"
...
TopBar::TopBar(BilletcoinGUI* _mainWindow, QWidget *parent) :
...
void TopBar::loadWalletModel(){
    ...
    // update the display unit, to not use the default ("Billetcoin")
    updateDisplayUnit();
