...
#include "qt/billetcoin/furabstractlistitemdelegate.h"
#include "qt/billetcoin/txviewholder.h"
#include "qt/billetcoin/tooltipmenu.h"
#include "qt/billetcoin/sendmultirow.h"
#include "qt/billetcoin/coldstakingmodel.h"
...
public:
    explicit ColdStakingWidget(BilletcoinGUI* parent);
    ~ColdStakingWidget();
