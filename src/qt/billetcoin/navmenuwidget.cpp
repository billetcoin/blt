...
#include "qt/billetcoin/forms/ui_navmenuwidget.h"
...
NavMenuWidget::NavMenuWidget(BilletcoinGUI *mainWindow, QWidget *parent) :
    ...
    ui(new Ui::NavMenuWidget)
{
    ...
    setCssProperty(ui->imgLogo, "img-nav-logo-billetcoin");
