...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, BilletcoinGUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, BilletcoinGUI *gui, double posX = 3);
