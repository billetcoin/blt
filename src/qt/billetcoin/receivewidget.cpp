...
#include "qt/billetcoin/forms/ui_receivewidget.h"
...
#include "qt/billetcoin/addressholder.h"
...
ReceiveWidget::ReceiveWidget(BilletcoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive BLT."));
