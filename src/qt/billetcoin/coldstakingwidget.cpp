...
#include "qt/billetcoin/coldstakingwidget.h"
#include "qt/billetcoin/forms/ui_coldstakingwidget.h"
#include "qt/billetcoin/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/billetcoin/requestdialog.h"
#include "qt/billetcoin/tooltipmenu.h"
#include "qt/billetcoin/furlistrow.h"
...
ColdStakingWidget::ColdStakingWidget(BilletcoinGUI* parent) :
    PWidget(parent),
    ...
    isLoading(false)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your BLTs, letting a hot node (24/7 online node)\nstake on your behalf, while you keep the keys securely offline."));
    ...
    ui->labelSubtitle2->setText(tr("Accept BLT delegation / Delegate BLT"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select BLT outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 BLT" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
