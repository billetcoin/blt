...
#include "qt/billetcoin/coincontrolpivwidget.h"
#include "qt/billetcoin/forms/ui_coincontrolpivwidget.h"
    ...
    ui(new Ui::CoinControlPivWidget)
{
    ...
    ui->labelTitle->setText("Select BLT Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("BLT");
    ...
    ui->labelValueAfter->setText("0.00 BLT");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 BLT");
    ui->labelValueFee->setText("0.00 BLT");
