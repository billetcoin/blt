...
#include "qt/billetcoin/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/billetcoin/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(BilletcoinGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(){
    ...
    message(CMD_REPLY, (tr("Welcome to the Billetcoin RPC console.") + "<br>" +
