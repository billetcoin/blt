...
#include "qt/billetcoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/billetcoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(BilletcoinGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to BilletcoinGUI::handleRestart()
