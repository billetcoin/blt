...
#include "qt/billetcoin/settings/settingsnetworkwidget.h"
#include "qt/billetcoin/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/billetcoin/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(BilletcoinGUI* _window, QWidget *parent) :
