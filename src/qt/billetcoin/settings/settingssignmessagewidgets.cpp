...
#include "qt/billetcoin/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(BilletcoinGUI* _window, QWidget *parent) :
