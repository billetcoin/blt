...
#include "qt/billetcoin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/billetcoin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(BilletcoinGUI* _window, QWidget *parent) :
