// Copyright (c) 2017-2018 The Billetcoin developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef Billetcoin_ZBLTWALLET_H
#define Billetcoin_ZBLTWALLET_H
...
public:
    CzBLTWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZBLT(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZBLT(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
