...
#ifndef Billetcoin_ZBLTTRACKER_H
#define Billetcoin_ZBLTTRACKER_H
...
public:
    CzBLTTracker(std::string strWalletFile);
    ~CzBLTTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzBLTWallet* zBLTWallet = NULL);
...
#endif //Billetcoin_ZBLTTRACKER_H
