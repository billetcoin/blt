...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/billetcoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/billetcoin-cli.cpp \
           src/billetcoin-tx.cpp \
           src/billetcoin.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/billetcoin.qrc src/qt/billetcoin_locale.qrc

TRANSLATIONS += src/qt/locale/billetcoin_bg.ts \
                src/qt/locale/billetcoin_de.ts \
                src/qt/locale/billetcoin_en.ts \
                src/qt/locale/billetcoin_es.ts \
                src/qt/locale/billetcoin_fi.ts \
                src/qt/locale/billetcoin_fr.ts \
                src/qt/locale/billetcoin_it.ts \
                src/qt/locale/billetcoin_ja.ts \
                src/qt/locale/billetcoin_pl.ts \
                src/qt/locale/billetcoin_pt.ts \
                src/qt/locale/billetcoin_ru.ts \
                src/qt/locale/billetcoin_sk.ts \
                src/qt/locale/billetcoin_sv.ts \
                src/qt/locale/billetcoin_vi.ts \
                src/qt/locale/billetcoin_zh_CN.ts \
                src/qt/locale/billetcoin_zh_TW.ts
