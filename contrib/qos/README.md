...
This means one can have an always-on billetcoind instance running, and another local billetcoind/billetcoin-qt instance which connects to this node and receives blocks from it.
