...
"""Verify that starting billetcoin with -h works as expected."""
import subprocess

from test_framework.test_framework import BilletcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(BilletcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start billetcoin with -h for help text")
        ...
        self.log.info("Start billetcoin with -version for version information")
