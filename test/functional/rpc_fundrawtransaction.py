...
class RawTransactionsTest(BilletcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid billetcoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid billetcoin address" in e.error['message'])
