...
from test_framework.billetcoin_node import BilletcoinTestNode
...
class Billetcoin_ColdStakingTest(BilletcoinTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(BilletcoinTestNode())
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, None, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 BLT from the pot)
...
if __name__ == '__main__':
    Billetcoin_ColdStakingTest().main()
