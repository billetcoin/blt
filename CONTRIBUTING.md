Contributing to Billetcoin Core
============================

The Billetcoin Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/billetcoin-project/billetcoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Billetcoin Core project, and is not to be
confused with overall Billetcoin Network Protocol consensus changes.

Whether a pull request is merged into Billetcoin Core rests with the project merge
...
Patches that change Billetcoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the Billetcoin consensus, it must have been
...
The project leader is the release manager for each Billetcoin Core release.
