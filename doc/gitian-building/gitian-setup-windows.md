...
The build script we'll be using is contained in the Billetcoin github repository ([contrib/gitian-build.py](https://github.com/billetcoin-project/billetcoin/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the Billetcoin repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/Billetcoin-Project/Billetcoin/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, billetcoin-detached-sigs, and billetcoin GitHub repos.
