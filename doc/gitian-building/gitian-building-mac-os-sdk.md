...
The script [extract-osx-sdk.sh](https://github.com/billetcoin-project/billetcoin/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
billetcoin/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/billetcoin-project/billetcoin/blob/master/doc/README_osx.md) for troubleshooting tips.